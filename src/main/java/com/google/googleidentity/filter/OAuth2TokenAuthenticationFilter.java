...
/**
 * The filter to protect resources using oauth2 token.
 * It is set before {@link UserAuthenticationFilter}.
 * If the token is valid, {@link UserSession} will be set.
 * Therefore, {@link UserAuthenticationFilter} will be passed.
 */
@Singleton
